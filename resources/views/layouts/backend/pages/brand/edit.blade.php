<x-backend.layout>
    <x-slot:title>Tác giả</x-slot:title>
    ...
    <div class="p-3 xl:p-6">
        <div class="flex flex-col gap-2 mb-6">
            ...
            <h1 class="capitalize font-bold text-2xl text-gray-800">Chỉnh sửa thông tin tác giả</h1>
        </div>
                        ...
                        <div class="aspect-[3/4] bg-white flex items-center justify-center rounded-xl">
                            ...
                            @else
                                <div class="border border-dashed border-gray-300 flex flex-col h-full items-center justify-center rounded-xl text-center text-gray-400 w-full">
                                    <i class="fa-feather-pointed fa-solid text-5xl"></i>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Write a short author description"
