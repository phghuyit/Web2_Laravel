<x-backend.layout>
    <x-slot:title>Contact Trash</x-slot:title>

    <div class="p-3 xl:p-6">
        <div class="mt-1 mb-6 flex items-center justify-between">
            <p class="text-xl font-bold uppercase">thung rac lien he</p>
        </div>
        ...
        <form method="GET" action="">
            <div class="flex gap-3">
                ...
                <a href="{{ route('contact.trash') }}" class="self-center rounded-lg bg-white px-4 py-2">Reset</a>
            </div>
        </form>
                    ...
                    <tbody>
                        @forelse ($contacts as $contact)
                            <tr class="border-t border-gray-200 text-center hover:bg-gray-50">
                                ...
                                <td class="px-1 py-3">{{ $contact->slug }}</td>
                                ...
                                <td class="align-middle px-1 py-3">
                                    <div class="flex flex-nowrap gap-2">
                                        <div class="rounded-lg p-3 text-sm shadow hover:bg-gray-100">
                                            <a href="#"><i class="fa-solid fa-arrows-rotate"></i><span class="ml-1 hidden xl:inline">Khoi phuc</span></a>
                                        </div>
                        ...
                        @empty
                            <tr>
                                <td class="p-6 text-center" colspan="9">Danh sach lien he trong thung rac rong</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
