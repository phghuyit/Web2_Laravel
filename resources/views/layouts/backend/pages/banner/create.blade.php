<x-backend.layout>
    <x-slot:title>Tạo Banner</x-slot:title>
    ...
    <div class="p-3 xl:p-6">
        <div class="flex flex-col gap-2 mb-6">
            ...
            <h1 class="capitalize font-bold text-2xl text-gray-800">Thêm banner mới</h1>
        </div>
        ...
        >
            ...
            <div class="gap-6 grid xl:grid-cols-[280px_minmax(0,1fr)]">
                <div class="space-y-5">
                    ...
                    <div>
                        <label for="image" class="block font-semibold mb-2 text-gray-700 text-sm">Tải ảnh</label>
                        <input
                            id="image"
                            name="image"
                            type="file"
                ...
                <div class="space-y-5">
                    ...
                    <div class="gap-5 grid md:grid-cols-3">
                        ...
                        <div>
                            ...
                            >
                                <option value="slideshow" {{ old('position', 'slideshow') == 'slideshow' ? 'selected' : '' }}>Slideshow</option>
                        ...
                        <div>
                            ...
                            <label class="cursor-pointer gap-3 inline-flex items-center mt-3">
                                ...
                                <span class="font-medium text-gray-700">Hiện</span>
                            </label>
                        </div>
                    </div>
