<x-backend.layout>
    ...
    <div class="p-3 xl:p-6">
        <div class="mb-6 flex flex-col gap-2">
            ...
            <h1 class="text-2xl font-bold capitalize text-gray-800">Thêm banner mới</h1>
        </div>
        ...
        >
            ...
            <div class="grid gap-6 xl:grid-cols-[280px_minmax(0,1fr)]">
                <div class="space-y-5">
                    ...
                    <div>
                        <label for="image" class="mb-2 block text-sm font-semibold text-gray-700">Tải ảnh</label>
                        <input
                            id="image"
                            name="image"
                            type="file"
