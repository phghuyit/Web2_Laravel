<x-backend.layout>
    ...
    <div class="p-3 xl:p-6">
        <div class="flex flex-col gap-2 mb-6">
            ...
            <h1 class="capitalize font-bold text-2xl text-gray-800">Thêm thể loại sách mới</h1>
        </div>
            ...
            <div class="gap-6 grid xl:grid-cols-[280px_minmax(0,1fr)]">
                <div class="space-y-5">
                    <div class="bg-gray-50 border border-gray-200 overflow-hidden p-4 rounded-2xl">
                        <div
                            class="aspect-[4/3] bg-white border border-dashed border-gray-300 flex items-center justify-center rounded-xl text-center text-gray-400">
                            <div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="gap-5 grid md:grid-cols-3">
                        <div>
                            <label for="parent_id" class="block font-semibold mb-2 text-gray-700 text-sm">Danh mục
                                cha</label>
                            <input id="parent_id" name="parent_id" type="number" value="{{ old('parent_id', 0) }}"
                                class="border border-gray-200 outline-none px-4 py-3 rounded-xl text-gray-700 transition w-full focus:border-orange-400 focus:ring-2 focus:ring-orange-100"
                                placeholder="0">
                        </div>
                        ...
                        <div>
                            <label for="sort_order" class="block font-semibold mb-2 text-gray-700 text-sm">Thứ
                                tự</label>
                            <input id="sort_order" name="sort_order" type="number" value="{{ old('sort_order', 1) }}"
                                class="border border-gray-200 outline-none px-4 py-3 rounded-xl text-gray-700 transition w-full focus:border-orange-400 focus:ring-2 focus:ring-orange-100"
                                placeholder="1">
                        </div>
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="6"
                            ...
                            placeholder="Viết mô tả ngắn cho danh mục">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
