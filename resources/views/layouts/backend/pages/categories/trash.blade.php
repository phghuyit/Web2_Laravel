                                ...
                                <td class="align-middle px-1 py-3">
                                    <div class="flex flex-nowrap gap-2">
                                        <div class="p-3 rounded-lg shadow text-sm hover:bg-gray-100">
                                            <form action="{{ route('cate.restore', $cate->id) }}" method="POST">@csrf @method('PUT')<button type="submit"><i class="fa-arrows-rotate fa-solid"></i><span class="hidden ml-1 xl:inline">Khoi phuc</span></button></form>
                                        </div>
                                        <div class="p-3 rounded-lg shadow text-red-500 text-sm hover:bg-gray-100">
                                            <form action="{{ route('cate.destroy', $cate->id) }}" method="POST">@csrf @method('DELETE')<button type="submit"><i class="fa-solid fa-trash"></i></button></form>
                                        </div>
                                    </div>
                                </td>
                            </tr>
